...
class CompBillingPage:
	...
	def set_comp_name(self, comp_name):
		...
		try:
			...
			print(
				'[CompBillingPage]set_comp_name---设置帐套名称失败，失败原因是是=>', str(e))
	...
	def get_comp_name(self):
		...
		try:
			...
			print(
				'[CompBillingPage] get_comp_name---获取帐套名称失败，失败原因是=>', str(e))
	...
	def set_legal_person_name(self, legal_person_name):
		...
		try:
			...
			print(
				'[CompBillingPage]set_legal_person_name---设置法定代表人失败，失败原因是=> %s', str(e))
	...
	def set_registered_capital(self, registered_num):
		...
		try:
			...
			print(
				'[CompBillingPage]set_registered_capital---填写注册资本失败，失败原因是=>', str(e))
	...
	def select_prov(self, prov_name):
		...
		try:
			...
			print(
				'[CompBillingPage]select_prov---选择省份失败，失败原因是', str(e))
	...
	def select_city(self, city_name):
		...
		try:
			...
			print(
				'[CompBillingPage]select_city---选择市失败，失败原因是', str(e))
