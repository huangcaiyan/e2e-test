...
class ContactPage(object):
    ...
    def set_contact_name(self,contact_name):
        try:
            ...
            print('[ContactPage] There was an exception when seet_contact_name=>',str(e))
    ...
    def select_contact_property(self,contact_property):
        try:
            ...
            print('[ContactPage] There was an exception when select_contact_property=>',str(e))
    ...
    def set_contact_name(self,contact_name):
        try:
            ...
            print('[ContactPage] There was an exception when set_contact_name=>',str(e))
    ...
    def set_account_name(self,account_name):
        try:
            ...
            print('[ContactPage] There was an exception when set_account_name=>',str(e))
