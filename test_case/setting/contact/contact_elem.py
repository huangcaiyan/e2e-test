...
# 账户名称 id
account_name_elem = 'input-accountName'
# 帐号 id
account_num_elem = 'input-accountNumber'
# 手机号
...
# 
# 列表－名称 id
table_name_elem = 'name'
# 列表－性质 id
table_contact_property_elem = 'property'
# 列表 － 往来名称 id
table_contact_name_elem = 'contactName'
# 列表 － 电话 id
table_phone_num_elem = 'phoneNumber'
# 列表 － 操作 编辑 id
table_edit_elem = 'editContact'
# 列表 － 操作 删除 id
table_delete_elem = 'deleteContact'
